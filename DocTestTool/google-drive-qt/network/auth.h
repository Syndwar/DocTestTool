...
public:
    QUrlQuery getOAuth2CodeUrl(const QString &scope, const QString &redirectUri, const QString &clientId , bool accessType = true, bool approvalPrompt = false, const QString &state = QString());
    QString getOAuth2Code(const QUrlQuery &url);
